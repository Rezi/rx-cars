	...
	let menus = [
		...
		},
		{
			...
			items: [
				...
				{ disabled: true, href: 'concat', name: 'concat' },
		...
		},
		{
			...
			items: [
				...
				{ disabled: true, href: 'concat-all', name: 'concatAll ' },
				{ disabled: true, href: 'exhaustAll', name: 'exhaustAll ' },
				{ disabled: true, href: 'merge-all', name: 'mergeAll ' },
				{ disabled: true, href: 'switch-all', name: 'switchAll ' },
		...
		},
		{
			...
			items: [
				...
				{ disabled: false, href: 'concat-map', name: 'concateMap ' },
		...
		},
		{
			...
			items: [
				...
				{ disabled: true, href: 'take', name: 'take' },
				{ disabled: true, href: 'take-last', name: 'takeLast' },
				{ disabled: true, href: 'take-until', name: 'takeUntil' },
